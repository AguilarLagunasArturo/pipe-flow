    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          client.println("<!DOCTYPE HTML><html> <head> <title>Control de Flujo</title> </head> <style> button{ width: 35%; height: 40px; margin: 5px; border-radius: 5px; border: none; font-size: 16px; } body{ background-color: #FFF; margin: 0px; margin-top: 80px; padding: 0px; } button{ background-color: #C9D9E6; color: #182526; } h2, h4 { color: #FFF; margin: 15px; } hr{ width: 70%; display: block; height: 1px; border: 0; border-top: 1px solid #ccc; } ul { position: fixed; top: 0; list-style-type: none; margin: 0; padding: 0; overflow: hidden;] } li { float: left; } li, a{ color: white; padding: 24px 16px; text-align: center; text-decoration: none; } li a:hover { background-color: #4a727a; } span{ font-size: 16px; padding-right: 15%; font-weight: bold; color: white; } .title{ font-weight: bold; font-size: 24px; color: white; margin-left: 25%; } .link{ font-size: 24px; color: white; float: right; padding-right: 0px; margin-right: 25%; } .header{ width: 100%; background-color: #54878C; } .footer{ bottom: 0; padding-top: 5px; padding-bottom: 5px; margin-top: 50px; width: 100%; background-color: #4B787D; text-align: right; } @media (min-width:320px) { /* smartphones, portrait iPhone, portrait 480x320 phones (Android) */ button{ width: 70%; height: 100px; font-size: 40px; margin: 30px; } body{ background-color: #FFF; margin: 0px; margin-top: 120px; padding: 0px; } li, a{ padding: 44px 16px; } .title{ font-size: 26px; margin-left: 14%; } .link{ font-size: 26px; margin-right: 14%; } span{ font-size: 26px; padding-right: 5%; } } @media (min-width:992px) { /* smartphones, portrait iPhone, portrait 480x320 phones (Android) */ button{ width: 35%; height: 40px; font-size: 20px; } .title{ font-size: 24px; margin-left: 25%; } .link{ font-size: 24px; margin-right: 25%; } span{ font-size: 16px; padding-right: 15%; } } </style> <body> <ul class='header'> <li class='title'>Control de flujo</li> <li class='link'><a href='https://github.com/AguilarLagunasArturo/pipe-flow'>Sobre el proyecto</a></li> </ul> <center> <br> <button class='S1_1' type='submit' onmousedown=location.href='/S1_1\'>Abrir sección 1</button> <button class='S1_0' type='submit' onmousedown=location.href='/S1_0\'>Cerrar sección 1</button><hr> <button class='S2_1' type='submit' onmousedown=location.href='/S2_1\'>Abrir sección 2</button> <button class='S2_0' type='submit' onmousedown=location.href='/S2_0\'>Cerrar sección 2</button><hr> <button class='S3_1' type='submit' onmousedown=location.href='/S3_1\'>Abrir sección 3</button> <button class='S3_0' type='submit' onmousedown=location.href='/S3_0\'>Cerrar sección 3</button><hr> <button class='S4_1' type='submit' onmousedown=location.href='/S4_1\'>Abrir sección 4</button> <button class='S4_0' type='submit' onmousedown=location.href='/S4_0\'>Cerrar sección 4</button><hr> <button class='S5_0' type='submit' onmousedown=location.href='/S5_0\'>Cerrar sección 5</button> <button class='S5_1' type='submit' onmousedown=location.href='/S5_1\'>Abrir sección 5</button><hr> <button class='S6_0' type='submit' onmousedown=location.href='/S6_0\'>Cerrar sección 6</button> <button class='S6_1' type='submit' onmousedown=location.href='/S6_1\'>Abrir sección 6</button><hr> <button class='S7_1' type='submit' onmousedown=location.href='/S7_1\'>Abrir sección 7</button> <button class='S7_0' type='submit' onmousedown=location.href='/S7_0\'>Cerrar sección 7</button><hr> <button class='S8_1' type='submit' onmousedown=location.href='/S8_1\'>Abrir sección 8</button> <button class='S8_0' type='submit' onmousedown=location.href='/S8_0\'>Cerrar sección 8</button><hr> <button class='R' type='submit' onmousedown=location.href='/R\'>Reiniciar sistema</button> <div class='footer'> <span>Sistema de tuberías automatizado</span> </div> </center> </body></html>");
          break;
        }
        if (c == '\n') {
